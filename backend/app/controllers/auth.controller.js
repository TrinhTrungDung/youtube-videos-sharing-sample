...
exports.register = (req, res) => {
    ...
    if (!passwordValidator.isPasswordStrong(password)) {
        return res.status(400).send({ message: "Your password must be at least 8 characters long, has at least one uppercase letter, one lowercase letter, one digit and one special character" });
    }
